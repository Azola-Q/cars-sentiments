...
YOUTUBE_API_KEY_1 = os.getenv("API_KEY_1")  # Replace with your first valid API key
...
class YouTubeCommentsService:
    ...
    def get_all_comments_data(self, max_videos=10, max_comments_per_video=50):
        ...
        try:
            videos = self.get_latest_videos(max_videos)  # Reduced from max_videos * 2 to save quota
            all_comments = []
